...
<head>
  ...
  <title>Reading:Multiple Choice Single Answer</title>
    ...
    <div class="container">
      ...
      <a href ="../index.php">
        <img border="0" alt="homepage" src="../img/my_logo.jpeg" width="100" height="70">
          ...
          <a class="navbar-brand js-scroll-trigger" href="#page-top">Reading: MCSA<a>
...
<div class="section">
<div align="justify">
<h5>Read the text and answer the multiple-choice question by selecting the correct response. Only one response is correct.</h5>
...
<table>
  <tr>
    Question:<?php echo $array[$counter]['mcsa_id'] ?> <td><?php echo $array[$counter]['mcsa_para'] ?></td>
  </tr>
</table>
<label for="Option1">
