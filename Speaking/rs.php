...
<table>
  <tr>
    ...
    Question:<?php echo $array[$counter]['rs_id'] ?>  
	</div>
  </tr>
</table>
<?php
    ...
    <div class="main">
		<div class="left">
				<div class="popup" onclick="popupMsg()">Transcipt
					<span class="popuptext" id="myPopup"style="height:35px; width:600px; text-align:center"> <?php echo $array[$counter]['resen_answer']; ?></span>
				</div>
		</div>
