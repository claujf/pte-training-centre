					...
					<div id="controls">
						...
						<button id="stopButton" disabled class="button">Stop</button>
							<div class="popup" onclick="popupMsg()">Stress Guide
								<span class="popuptext" id="myPopup"style="height:200px; width:600px; text-align:left"><?php echo $array[$counter]['s_guide'] ?> </span>
							</div>
							<div class="popup" onclick="popupAns()">Pause Guide
								<span class="popuptext" id="mySecondPopup"  style="height:200px; width:600px; text-align:left"><?php echo $array[$counter]['p_guide'] ?> </p>							
								</span>
							</div>
					</div></br>
