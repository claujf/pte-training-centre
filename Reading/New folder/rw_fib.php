...
<table>
  <tr>
    ...
    Question:<?php echo $array[$counter]['rw_fib_id'] ?>  <?php echo $array[$counter]['rw_fib_title']?> 
	</div>
  </tr>
</table></br>
...
<form action="rw_fib.php" method="post">
<div>
...
<?php echo $array[$counter]['rw_fib_answer'] ?></span>
 </div>
</div>
</form>
