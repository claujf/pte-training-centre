...
<td><?php echo $array[$counter]['mcma_option1'] ?></td>
</label>
<br>
<label for="Option2">
<input type="checkbox" name="Option2" id = "Option2" value="Option2">
<td><?php echo $array[$counter]['mcma_option2'] ?><br></td>
</label>
<br>
<label for="Option3">
<input type="checkbox" name="Option3" id = "Option3" value="Option3">
<td><?php echo $array[$counter]['mcma_option3'] ?><br></td>
</label>
<br>
<label for="Option4">
<input type="checkbox" name="Option4" id = "Option4" value="Option4">
