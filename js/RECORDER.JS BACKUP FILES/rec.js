(async () => {
  ...
  try {
    ...
    alert('Es konnte kein Mikrofon gefunden werden', err);
  }
  ...
  function stop() {
    ...
    link.download = 'PatientenFall.wav';
  }
  ...
  function visualize() {
    ...
    if(visualSetting === "sinewave") {
      ...
      var draw = function() {
        ...
        canvasCtx.fillStyle = 'rgb(66, 159, 218)';
        canvasCtx.fillRect(0, 0, WIDTH, HEIGHT);

        canvasCtx.lineWidth = 2;
        canvasCtx.strokeStyle = 'rgb(211, 64, 63)';
  ...
  document.querySelector('#record').onclick = (e) => {
    ...
    document.querySelector('#stop').style.display = 'inline'
            document.querySelector('#audiobox').style.display = 'none'
    document.querySelector('#icon').style.background = 'rgb(211, 64, 63)'
    document.querySelector('#icon').style.color = 'white'

    document.querySelector('body').style.border = '10px solid rgb(211, 64, 63)'
  ...
  document.querySelector('#stop').onclick = (e) => {
    ...
    document.querySelector('#record').style.display = 'inline'
        document.querySelector('#audiobox').style.display = 'inline'
        document.querySelector('#icon').style.background = 'white'
        document.querySelector('#icon').style.color = '#429fda'
   document.querySelector('body').style.border = '10px solid #429fda'
