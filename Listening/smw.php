...
<head>
  ...
  <title>Select Missing Words</title>
    ...
    <div class="container">
      ...
      <a href ="../index.php">
        <img border="0" alt="homepage" src="../img/my_logo.jpeg" width="100" height="70">
          ...
          <a class="navbar-brand js-scroll-trigger" href="#page-top">Select Missing Words</a>
...
<h5>You will hear a recording about fiction writing. At the end of the recording the lost word or group of words has been reploced by a beep. Select the correct option to complete the recording.</h5>
  <!-- Timer -->
...
$incr1=($incr1-1);
$q= "SELECT * from l_smw where smw_id = '$idnum[0]'";
...
$q= "select * from l_smw where smw_id = '$idnum[$counter]'";
$result2 = mysqli_query($con,$q) or die('Query failed: ');
break;
case 'button2':
$counter = ($_POST['counter']);
...
?>	
  ...
  <form action="/sstdata.php">
         ...
         <br>
		 <input type="radio" name="question1" value="option5">d)
         <br>
		 <input type="radio" name="question1" value="option6">d)
         <br>
      </form>
  </form>
  <br><br>
...
<form action="smw.php" method="post">
