    ...
    <div class="container">
      ...
      <a href ="../index.php">
        <img border="0" alt="homepage" src="../img/my_logo.jpeg" width="100" height="70">
          ...
          <a class="navbar-brand js-scroll-trigger" href="#page-top">Write Essay</a>
          <!--
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li ckass="nav-item mx-0 mx-lg-1">
            <div class="writingdd">
              ...
              <div class="dropdown-content">
                <a href="../swt/swt.php">Summarize Written Text</a>
                <a>Write Essay</a>
              </div>
            </div>
          </li>  
...
$incr1=($incr1-1);
$q= "SELECT * from w_essay where essay_id = '$idnum[0]'";
...
$q= "select * from w_essay where essay_id = '$idnum[$counter]'";
$result2 = mysqli_query($con,$q) or die('Query failed: ');
break;
case 'button2':
$counter = ($_POST['counter']);
