...
<?php 
    ...
    mysqli_query($link,$query) or die ('Error query database');
    ...
    while($record = mysqli_fetch_array($result)) {
        ...
        if ($record['webadmin'] == 1) {
            echo "<td>Admin</td>"; 
        } else {
            echo "<td>Student</td>";
        }
        echo "<td><a href='edit-student.php?stid=" . $record['id'] . "'><i class='fa fa-edit' title ='Edit Record'></i></a></td>";
        echo "</tr>";
        $cnt = $cnt + 1 ;
    }
    ?>
