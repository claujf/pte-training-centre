...
$incr1=($incr1-1);
$q= "SELECT * from l_wfd where  wfd_id = '$idnum[0]'";
...
$q= "select * from l_wfd where  wfd_id = '$idnum[$counter]'";
$result2 = mysqli_query($con,$q) or die('Query failed: ');
break;
case 'button2':
$counter = ($_POST['counter']);
...
?>
				...
				<div class="popup" onclick="popupAns()"> Transcript 
					<span class="popuptext" id="mySecondPopup">1)"mainly" due to ecomomic..
					</span>
				</div></br></br>
