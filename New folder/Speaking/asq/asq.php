...
<div class="section">
    ...
    <h5 align="justify">You will hear a question. Please give a simple and short answer. Often just one or a few words is enough.</h5><br>
...
echo "<br>";
 ...
 $db = mysqli_connect('localhost','root','','pte')
...
$element .= "<audio autoplay controls>";
